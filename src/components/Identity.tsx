...
const Identity: React.FC = () => {
  ...
  return (
    <div className="font-semibold font-sans text-center flex flex-col items-center justify-between">
      <div className="">
        <h1>insert scenario still</h1>
        <h1>insert pic still</h1>
      </div>
      <section className="px-12 flex flex-col items-center justify-center ring ring-2 ring-red">
        <div className="underline">{currentQuestion.question}</div>
        <div className="h-48 w-full grid grid-rows-2 grid-cols-2 gap-8">
